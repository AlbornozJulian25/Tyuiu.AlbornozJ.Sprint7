...
namespace Tyuiu.AlbornozJ.Sprint7.Project.V15.Lib
{
    public class DataService
    {
        ...
        public decimal GetTotalAmount(string filePath)
        {            
            string[,] data = LoadFromFileData(filePath);
            decimal total = 0;             
        ...
        public decimal GetAverageAmount(string filePath)  
        {
            string[,] data = LoadFromFileData(filePath);
            decimal total = 0;
            int count = 0;  
        ...
        public string[,] SearchByOrganization(string filePath, string organization)
        {
            string[,] allData = LoadFromFileData(filePath);
            int matchCount = 0;            
